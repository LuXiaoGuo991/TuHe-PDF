  ...
  const convert = async () => {
    if (state.files.length === 0) {
      showAlert(
        ...
        translate(
          'tools:odsToPdf.dynamic.d2f643f113',
    ...
    try {
      ...
      showLoader(
        translate('tools:odsToPdf.dynamic.4fb6de5f25', 'Loading engine...')
      );
      ...
      if (state.files.length === 1) {
        ...
        showLoader(
          translate(
            'tools:odsToPdf.dynamic.4dd49077fa',
        ...
        hideLoader();
        showAlert(
          translate('tools:odsToPdf.dynamic.a6fda8c5bb', 'Conversion Complete'),
          translate(
            'tools:odsToPdf.dynamic.77a1ff6cd4',
        ...
        showLoader(
          translate(
            'tools:odsToPdf.dynamic.d228b70c8d',
        ...
        for (let i = 0; i < state.files.length; i++) {
          ...
          showLoader(
            translate(
              'tools:odsToPdf.dynamic.f6da621f2c',
        ...
        showAlert(
          translate('tools:odsToPdf.dynamic.a6fda8c5bb', 'Conversion Complete'),
          translate(
            'tools:odsToPdf.dynamic.965300d792',
      ...
      showAlert(
        ...
        translate(
          'tools:odsToPdf.dynamic.db4e24f563',
