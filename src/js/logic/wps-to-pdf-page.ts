  ...
  const convert = async () => {
    if (state.files.length === 0) {
      showAlert(
        ...
        translate(
          'tools:wpsToPdf.dynamic.4af39b0805',
    ...
    try {
      ...
      showLoader(
        translate('tools:wpsToPdf.dynamic.839bb28344', 'Loading engine...')
      );
      ...
      if (state.files.length === 1) {
        ...
        showLoader(
          translate(
            'tools:wpsToPdf.dynamic.87eac04e52',
        ...
        hideLoader();
        showAlert(
          translate('tools:wpsToPdf.dynamic.97bc687412', 'Conversion Complete'),
          translate(
            'tools:wpsToPdf.dynamic.41793edcbd',
        ...
        showLoader(
          translate(
            'tools:wpsToPdf.dynamic.037a6acbeb',
        ...
        for (let i = 0; i < state.files.length; i++) {
          ...
          showLoader(
            translate(
              'tools:wpsToPdf.dynamic.8852f46764',
        ...
        showAlert(
          translate('tools:wpsToPdf.dynamic.97bc687412', 'Conversion Complete'),
          translate(
            'tools:wpsToPdf.dynamic.5c94ad6bce',
