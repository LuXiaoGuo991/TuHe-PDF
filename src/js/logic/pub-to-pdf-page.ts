  ...
  const convert = async () => {
    if (state.files.length === 0) {
      showAlert(
        ...
        translate(
          'tools:pubToPdf.dynamic.dbf215a4fb',
    ...
    try {
      ...
      showLoader(
        translate('tools:pubToPdf.dynamic.1d973bb300', 'Loading engine...')
      );
      ...
      if (state.files.length === 1) {
        ...
        showLoader(
          translate(
            'tools:pubToPdf.dynamic.b0ddd3bf3e',
        ...
        hideLoader();
        showAlert(
          translate('tools:pubToPdf.dynamic.3f2b4785cf', 'Conversion Complete'),
          translate(
            'tools:pubToPdf.dynamic.b8f690887c',
        ...
        showLoader(
          translate(
            'tools:pubToPdf.dynamic.d60ace324c',
        ...
        for (let i = 0; i < state.files.length; i++) {
          ...
          showLoader(
            translate(
              'tools:pubToPdf.dynamic.d616d0cd6d',
        ...
        showAlert(
          translate('tools:pubToPdf.dynamic.3f2b4785cf', 'Conversion Complete'),
          translate(
            'tools:pubToPdf.dynamic.9df6f453cf',
      ...
      showAlert(
        ...
        translate(
          'tools:pubToPdf.dynamic.b1f64053ff',
