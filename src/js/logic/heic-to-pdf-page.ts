  ...
  if (files.length > 0) {
    ...
    files.forEach((file, index) => {
      ...
      sizeSpan.textContent = translate(
        'tools:heicToPdf.dynamic.37dc2dff42',
...
async function convert() {
  if (files.length === 0) {
    showAlert(
      ...
      translate(
        'tools:heicToPdf.dynamic.5088e5e744',
  ...
  showLoader(
    translate('tools:heicToPdf.dynamic.858af38004', 'Converting HEIC to PDF...')
  );
  try {
    ...
    showAlert(
      ...
      translate(
        'tools:heicToPdf.dynamic.14f5decb21',
    ...
    showAlert(
      ...
      translate(
        'tools:heicToPdf.dynamic.b114f617f1',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const handleFileSelect = (newFiles: FileList | null) => {
    ...
    if (validFiles.length < newFiles.length) {
      showAlert(
        translate('tools:heicToPdf.dynamic.d48f8cda5c', 'Invalid Files'),
        translate(
          'tools:heicToPdf.dynamic.a042ab46bb',
