  ...
  const convert = async () => {
    if (state.files.length === 0) {
      showAlert(
        ...
        translate(
          'tools:odgToPdf.dynamic.2a61c4b789',
    ...
    try {
      ...
      showLoader(
        translate('tools:odgToPdf.dynamic.245fd93b2b', 'Loading engine...')
      );
      ...
      if (state.files.length === 1) {
        ...
        showLoader(
          translate(
            'tools:odgToPdf.dynamic.333a6ea118',
        ...
        hideLoader();
        showAlert(
          translate('tools:odgToPdf.dynamic.34b6ede781', 'Conversion Complete'),
          translate(
            'tools:odgToPdf.dynamic.475c73b9d1',
        ...
        showLoader(
          translate(
            'tools:odgToPdf.dynamic.218c91e363',
        ...
        for (let i = 0; i < state.files.length; i++) {
          ...
          showLoader(
            translate(
              'tools:odgToPdf.dynamic.f8300101f6',
        ...
        showAlert(
          translate('tools:odgToPdf.dynamic.34b6ede781', 'Conversion Complete'),
          translate(
            'tools:odgToPdf.dynamic.a3b70b6e1d',
      ...
      showAlert(
        ...
        translate(
          'tools:odgToPdf.dynamic.20c203b8e3',
