    ...
    try {
      if (state.files.length === 0) {
        showAlert(
          ...
          translate(
            'tools:xpsToPdf.dynamic.7d896aa183',
      ...
      showLoader(
        translate('tools:xpsToPdf.dynamic.791c680372', 'Loading engine...')
      );
      ...
      if (state.files.length === 1) {
        ...
        showLoader(
          translate(
            'tools:xpsToPdf.dynamic.ba195f6b9f',
        ...
        showAlert(
          translate('tools:xpsToPdf.dynamic.3c6c3601a5', 'Conversion Complete'),
          translate(
            'tools:xpsToPdf.dynamic.75b9ac74b8',
        ...
        showLoader(
          translate('tools:xpsToPdf.dynamic.236aadb8c0', 'Converting files...')
        );
        ...
        for (let i = 0; i < state.files.length; i++) {
          ...
          showLoader(
            translate(
              'tools:xpsToPdf.dynamic.726bc61755',
        ...
        showAlert(
          translate('tools:xpsToPdf.dynamic.3c6c3601a5', 'Conversion Complete'),
          translate(
            'tools:xpsToPdf.dynamic.9c0951bc36',
